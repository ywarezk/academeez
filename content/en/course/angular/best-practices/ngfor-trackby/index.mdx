---
title: "Angular best practice tip: use *ngFor trackBy"
...
<Sandpack 
	...
	files={{
		"src/main.ts": {hidden: true, code: `import "@angular/compiler";
...
`},
		"src/app/app.config.ts": { hidden: true, code: `import { ApplicationConfig } from '@angular/core';
