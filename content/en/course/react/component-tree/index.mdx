...
In the <Link className="duration-100 leading-normal transition ease-in hover:border-opacity-100 border-opacity-0 inline border-link border-b text-green" href="/en/course/react/component">previous lesson</Link> we learned that React is a library that helps us create a UI components.
