...
![app.module.ts changes](https://github.com/ywarezk/academeez/blob/main/content/en/course/angular/ngrx/installing-ngrx-store/ng-add-devtools-change.png?raw=true)
