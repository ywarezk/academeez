...
duration: 66
short_description: Asynchronous code is part of your code that will run in the future.
Javascript provides us many tools and best practices for dealing with these common scenarios.
description: You probably noticed that when working with Javascript, there is a lot of cases where you have to pass a callback function, and that callback function will be called asynchronously some time in the future. 
