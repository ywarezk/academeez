...
short_description: To reduce bundle size, you can load a component only when needed
description: To reduce bundle size, you can load a component only when needed
slug: lazy-loading
link: /courses/react/optimizing-components/lazy-loading
...
code: https://github.com/ywarezk/academeez/raw/main/libs/courses/03_react/09_optimizing-components/06_lazy-loading/example
---
