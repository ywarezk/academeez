---
title: Initial Load is too slow!
short_description: When creating a single page application with React, we might have a problem with the initial load time.
description: When creating a single page application with React, we might have a problem with the initial load time.
slug: initial-load
link: /courses/react/server-side-rendering/initial-load
