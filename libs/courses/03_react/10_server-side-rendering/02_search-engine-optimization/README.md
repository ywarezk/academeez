---
title: Search Engine Optimization problem
short_description: Another big problem we have with Single Page Applications is the poor SEO result.
description: Another big problem we have with Single Page Applications is the poor SEO result.
slug: search-engine-optimization
link: /courses/react/server-side-rendering/search-engine-optimization
