...
short_description: With Server Side Rendering we can make a node server, generate HTML from our React Components
description: With Server Side Rendering we can make a node server, generate HTML from our React Components.
slug: server-side-rendering
link: /courses/react/server-side-rendering
