---
title: Redux Toolkit
short_description: Redux best practices using the Redux Toolkit library
description: Redux best practices using the Redux Toolkit library
slug: rtk
link: /courses/react/redux/rtk
