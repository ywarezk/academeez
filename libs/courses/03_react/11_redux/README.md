---
title: Redux - Managing application data
short_description: Learn to use Redux state management, to manage the data in our React app
description: Learn to use Redux state management, to manage the data in our React app
slug: redux
link: /courses/react/redux
