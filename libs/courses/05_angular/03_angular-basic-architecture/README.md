...
short_description: Going over angular architecture.
description: 
  In this lesson we are going over the different architecture elements of an angular app, and where and how each element is used.
...
link: /courses/angular/basic-architecture
order: 2
---
