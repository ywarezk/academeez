...
short_description: Components are the building blocks of the UI of an angular app.
description: 
  Component usually turns to a new reusable tag.
  A component is in charge of displaying part of the UI and update that UI if needed.
...
link: /courses/angular/component
order: 3
---
