---
title: '@angular/common directives'
short_description: Angular ships with some nifty directives you can use.
description: In this lesson we will learn about angular popular build in directives that you can use
...
link: /courses/angular/directive/common-directives
---
