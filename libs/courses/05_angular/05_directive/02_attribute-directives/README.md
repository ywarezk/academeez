...
short_description: Directives that effect template attributes , but do not change the DOM
description: Directives that effect template attributes , but do not change the DOM
...
link: /courses/angular/directive/attribute-directives
---
