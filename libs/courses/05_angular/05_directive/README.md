---
title: "@Directive"
short_description: With directives we can add reusable logic to our template items.
description: With directives we can add reusable logic to our template items.
...
link: /courses/angular/directive
order: 4
---
