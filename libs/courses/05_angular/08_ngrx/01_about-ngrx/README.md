---
title: What is NGRX
short_description: NGRX helps us manage our application data using redux state management pattern
description: NGRX helps us manage our application data using redux state management pattern
slug: ngrx
link: /courses/angular/ngrx
