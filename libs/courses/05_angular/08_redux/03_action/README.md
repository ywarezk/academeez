---
title: Action
short_description: Changes to the Redux state is done via Actions
description: Changes to the Redux state is done via Actions
slug: action
link: /courses/angular/redux/action
