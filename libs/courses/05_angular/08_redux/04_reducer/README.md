---
title: Reducer
short_description: When a Redux Action is dispatched, the Reducer determine the next State
description: When a Redux Action is dispatched, the Reducer determine the next State
slug: reducer
link: /courses/angular/redux/reducer
