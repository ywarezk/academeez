---
title: Redux with RXJS
short_description: Redux can be implemented using RXJS
description: Redux can be implemented using RXJS
slug: redux-with-rxjs
link: /courses/angular/redux/redux-with-rxjs
...
Redux can also be implemented using RXJS
