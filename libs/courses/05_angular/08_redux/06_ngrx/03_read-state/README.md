---
title: Reading from state
short_description: Read information from the state in the store
description: Read information from the state in the store
slug: read-state
link: /courses/angular/redux/ngrx/read-state
code: https://github.com/ywarezk/academeez/raw/main/libs/courses/05_angular/08_redux/06_ngrx/03_read-state/example
