...
short_description: Change the state using actions and reducers
description: Change the state using actions and reducers
slug: change-state-actions-reducers
link: /courses/angular/redux/ngrx/change-state-actions-reducers
