---
title: Redux
short_description: Managing your angular application data using Redux
description: Managing your angular application data using Redux
slug: redux
link: /courses/angular/redux
