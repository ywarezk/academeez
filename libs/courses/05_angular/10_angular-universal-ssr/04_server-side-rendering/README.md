...
short_description: Server Side Rendering is the ability of a Node.js server to create HTML of our angular app.
description: Server Side Rendering is the ability of a Node.js server to create HTML of our angular app.
slug: server-side-rendering
link: /courses/angular/angular-universal-ssr/server-side-rendering
