---
title: Prerendering
short_description: For the static pages, we can create their HTML at build time.
description: For the static pages, we can create their HTML at build time.
slug: prerender
link: /courses/angular/angular-universal-ssr/prerender
