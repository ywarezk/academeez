---
title: HttpClient server requests
short_description: How to deal with requests in SSR
description: How to deal with requests in SSR
slug: httpclient-server-requests
link: /courses/angular/angular-universal-ssr/httpclient-server-requests
