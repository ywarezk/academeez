...
short_description: With Server Side Rendering we can render angular components in the server to create a full HTML of our page.
description: With Server Side Rendering we can render angular components in the server to create a full HTML of our page.
slug: angular-universal-ssr
link: /courses/angular/angular-universal-ssr
