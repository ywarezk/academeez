...
short_description: Create a unique token to register non class values
description: Create a unique token to register non class values
slug: injection-token
