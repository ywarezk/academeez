---
title: Static module create method
short_description: To make our module more generic, there are times when we require configurations passed to the module, for that we can use a static create method.
description: To make our module more generic, there are times when we require configurations passed to the module, for that we can use a static create method.
slug: static-module-create
link: /courses/angular/di/static-module-create
