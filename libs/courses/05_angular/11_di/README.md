...
short_description: Dependency Injection (DI) - how it works, and patterns
description: Dependency Injection (DI) - how it works, and patterns
slug: di
link: /courses/angular/di
