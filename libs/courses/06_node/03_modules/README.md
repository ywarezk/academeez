...
short_description: A Node app is constructed from different files and packages.
  We will learn how the modules system in Node.js allow us to achieve that.
description: Using require, and module.exports we can seperate our app to different files, and also use community packages.
bg_img: https://github.com/ywarezk/academeez/raw/main/libs/courses/03_javascript/bg.png
slug: modules
link: /courses/node/modules
