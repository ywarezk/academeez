...
short_description: Process is a class that extends EventEmitter and expose us with some nifty events
description: Process is a class that extends EventEmitter and expose us with some nifty events
bg_img: https://github.com/ywarezk/academeez/raw/main/libs/courses/03_javascript/bg.png
slug: process-events
link: /courses/node/asynchronous-programming/events/process-events
