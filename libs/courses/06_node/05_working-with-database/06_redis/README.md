---
title: Redis 
short_description: In-memory database
description: In-memory, key-value database, used mostly for caching and message broker.
slug: redis
link: /courses/node/working-with-database/redis
