...
duration: 66
short_description: NPM - Node Package Manager, is the cli tool we use to install Javascript packages.
description: With NPM we can install community Javascript packages, publish our own packages, and help us with version managment of our Javascript libraries.
author: Yariv Katz
