---
title: Graphql Query - Creating the root of the graph
short_description: How to create the root of our graph
description: How to create the root of our graph
slug: query-root-graph
link: /courses/express/graphql/query-root-graph
