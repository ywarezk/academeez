---
title: Our first query - Hello World
short_description: Create a Graphql server with an hello world query using Apollo Server
description: Create a Graphql server with an hello world query using Apollo Server
slug: hello-world-apollo-server
link: /courses/express/graphql/hello-world-apollo-server
...
code: https://github.com/ywarezk/academeez/raw/main/libs/courses/05_graphql/03_hello-world/example
---
