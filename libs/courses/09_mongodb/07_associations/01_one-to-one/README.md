---
title: One to one
short_description: A document in a collection is connected to another document
description: A document in a collection is connected to another document
slug: one-to-one
link: /courses/mongodb/associations/one-to-one
