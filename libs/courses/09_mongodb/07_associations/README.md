---
title: Collections associations
short_description: Multiple collections in MongoDB can be associated to each other
description: Multiple collections in MongoDB can be associated to each other
slug: associations
link: /courses/mongodb/associations
