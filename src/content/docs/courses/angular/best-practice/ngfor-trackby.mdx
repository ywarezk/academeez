...
authors:
  - yariv-katz
video:
  videoUrl: https://www.youtube.com/watch?v=XOMY6S6GcZw
  duration: 1016
...
<div class="not-content flex">
    ...
    title="Use *ngFor trackBy in Angular - video"
    allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
    allowFullScreen
    loading="lazy"
    referrerPolicy="strict-origin-when-cross-origin"
    aria-label="Use *ngFor trackBy in Angular - video"
    aria-describedby="iframe-video-description"
	/>
</div>

<span id="iframe-video-description" class="sr-only">
This video explains how to use the *ngFor trackBy function in Angular to improve the performance of your applications by optimizing the rendering of lists, with practical examples and best practices.
</span>
...
Notice that on every add we are completely recreating the list, we are using the `clone` function to clone the list and add a new item to the list.  
