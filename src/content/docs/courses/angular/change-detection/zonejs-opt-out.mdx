...
<div class="not-content flex">
	<iframe
		...
		title="Angular - Opt-Out Zone.js - video"
		allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
		allowFullScreen
		loading="lazy"
		referrerPolicy="strict-origin-when-cross-origin"
		aria-label="Angular - Opt-Out Zone.js - video"
		aria-describedby="iframe-video-description"
	/>
</div>

<span id="iframe-video-description" class="sr-only">
This video explains the implications of working with Angular without Zone.js, including how to manually trigger change detection and optimize performance.
</span>
