...
<div class="not-content flex">
    ...
    title="Angular - Remove @ngrx/store-devtools in production - video"
    allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
    allowFullScreen
    loading="lazy"
    referrerPolicy="strict-origin-when-cross-origin"
    aria-label="Angular - Remove @ngrx/store-devtools in production - video"
...
In production `@ngrx/store-devtools` should be completely removed from the bundle.  
...
`@ngrx/store-devtools` is completely removed from the bundle.
