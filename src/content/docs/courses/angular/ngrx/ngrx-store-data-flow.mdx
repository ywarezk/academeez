...
<div class="not-content flex">
	<iframe
		...
		title="Angular - NGRX Store data flow - video"
		allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
		allowFullScreen
		loading="lazy"
		referrerPolicy="strict-origin-when-cross-origin"
		aria-label="Angular - NGRX Store data flow - video"
		aria-describedby="iframe-video-description"
	/>
</div>

<span id="iframe-video-description" class="sr-only">
This video explains the data flow in @ngrx/store, a state management library for Angular, covering key concepts such as Store, Actions, and Reducers, with practical examples and best practices.
</span>
