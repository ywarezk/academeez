...
video:
  videoUrl: https://www.youtube.com/watch?v=N3z4ivBJqr0
  duration: 874
  publishDate: 2023-10-23
  tags:    
    - Angular
...
<div class="not-content flex">
    ...
    title="Angular - NGRX State - video"
    allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
    allowFullScreen
    loading="lazy"
    referrerPolicy="strict-origin-when-cross-origin"
    aria-label="Angular - NGRX State - video"
    aria-describedby="iframe-video-description"
	/>
</div>

<span id="iframe-video-description" class="sr-only">
This video explains the key facts about the state managed by NGRX in Angular applications, including its immutability, structure, and best practices for organization and serialization.
</span>
