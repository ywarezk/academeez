...
sources: 
  - url: "https://github.com/Nerdeez/terragrunt-catalog/tree/lesson-01"
...
<div class="not-content flex">
  <iframe
    ...
    title="FluxCD installation with flux-cli - video"
    allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
    allowFullScreen
    loading="lazy"
    referrerPolicy="strict-origin-when-cross-origin"
    aria-label="FluxCD installation with flux-cli - video"
    aria-describedby="iframe-video-description"
  />
</div>

<span id="iframe-video-description" class="sr-only">
This video explains how to install FluxCD on a Kubernetes cluster using the flux-cli tool, including prerequisites, configuration of a Git repository for GitOps, and practical steps to bootstrap Flux on the cluster.
</span>
...
For the sake of this lesson we will not explain how to create a managed k8s cluster in a cloud provider, but we do recommend to create a minimal managed cluster in one of the cloud providers (In this course we will use [GKE](https://cloud.google.com/kubernetes-engine) - a GCP managed cluster).
...
We will also create an `infrastructure` folder for shared resources between the clusters like nginx ingress controller.
...
The full source code for this lesson is available [here](https://github.com/Nerdeez/terragrunt-catalog/tree/lesson-01)