...
authors:
  - yariv-katz
video:
  videoUrl: https://www.youtube.com/watch?v=bZpiVijzd2g
  duration: 3089
...
<div class="not-content flex">
	<iframe
		...
		title="Git - Clean your commits - video"
		allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
		allowFullScreen
		loading="lazy"
		referrerPolicy="strict-origin-when-cross-origin"
		aria-label="Git - Clean your commits - video"
		aria-describedby="iframe-video-description"
	/>
</div>
<span id="iframe-video-description" class="sr-only">
This video explains how to clean your commits in Git before pushing them to the remote repository, covering techniques such as amending commits, interactive rebasing, and resetting commits to maintain a clear and organized commit history.
</span>
...
We need to think before automatically committing all changes, think about our plan, think about the logical group of progress in our plan,
...
we can stage the changes and amend the commit with the command
...
become better at it and controller all those commands we learned in this lesson