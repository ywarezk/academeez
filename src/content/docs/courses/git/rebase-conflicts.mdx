...
authors:
  - yariv-katz
video:
  videoUrl: https://www.youtube.com/watch?v=p8JFivti0hU
  duration: 4305
...
<div class="not-content flex">
	<iframe
		...
		title="Git - rebase conflicts - video"
		allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
		allowFullScreen
		loading="lazy"
		referrerPolicy="strict-origin-when-cross-origin"
		aria-label="Git - rebase conflicts - video"
...
- `ours` - represent the branch that we rebase on top of (the `main` branch).
...
That trial and error is not necessarily something you want to keep in your commit history, and at times can be sufficient just placing a trial you did in a commit body instead of creating a full commit.
...
`git pull` with no additional argument will pull from the upstream branch (provided there is one) and merge the changes into the current branch.
