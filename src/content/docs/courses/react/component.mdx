...
<div class="not-content flex">
	<iframe
		...
		title="React Component - video"
		allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
		allowFullScreen
		loading="lazy"
		referrerPolicy="strict-origin-when-cross-origin"
		aria-label="React Component - video"
...
React essence is to give you an easy api to create reusable UI components. A component is a function that returns a JSX syntax (resembles HTML) that describes how the component should look like.  
