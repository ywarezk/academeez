---
title: 4. Props Introduction
description: Props are a way to pass information from a component to the JSX children they are placing. In this lesson we will pass those props to familiar HTML tags like `<img>`, and `<button>` and while doing so learn some basic rules regarding those props.
