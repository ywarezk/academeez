...
sidebar:  
  order: 11
  label: 5.3 Props with TypeScript
---
...
<div class="not-content flex">
	<iframe
		...
		width="560"
		height="315"
		src="https://www.youtube.com/embed/fBqnp8C7HzM?si=2fd4PxyX--n95bOB"
		title="React Props with TypeScript - Complete Tutorial for Type-Safe Components"
		allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
		allowFullScreen
		loading="lazy"
		referrerPolicy="strict-origin-when-cross-origin"
		aria-label="React Props with TypeScript - Complete Tutorial for Type-Safe Components"
