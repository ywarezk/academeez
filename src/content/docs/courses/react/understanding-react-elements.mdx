...
React will give you tools to create a VirtualDOM and update and maintain that VirtualDOM, it will later take that VirtualDOM and update the real DOM in a really quick way to match your virtual dom.
...
Also each component will take care of the change happening in that component but we will talk about component changes in our lesson about React components.
