...
sources:
  - title: pre-commit-terraform
    url: https://github.com/Nerdeez/terragrunt-catalog/blob/lesson-06/.pre-commit-config.yaml
sidebar:
  order: 6
video:
  videoUrl: https://www.youtube.com/shorts/UrZI2Eic2ms
  duration: 52
...
<div class="not-content flex">
  <iframe
    ...
    width="560"
    height="315"
    src="https://www.youtube.com/embed/UrZI2Eic2ms?si=W_Hq2xlxmB5UY56x"
    title="pre-commit-terraform for prettier Terraform files - Video"
    allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
    allowFullScreen
    loading="lazy"
    referrerPolicy="strict-origin-when-cross-origin"
    aria-label="pre-commit-terraform for prettier Terraform files - Video"
    aria-describedby="iframe-video-description"
  />
</div>
<span id="iframe-video-description" class="sr-only">
This video demonstrates how to set up pre-commit-terraform hooks to format Terragrunt configuration files before committing.
</span>
...
since we already committed a lot of files before we installed the hooks we can run the hooks on all the files in the project by running the following command:
