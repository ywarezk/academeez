...
sidebar:
  order: 8
sources:
  - url: "https://github.com/Nerdeez/terragrunt-catalog/tree/lesson-08"
    title: "change root terragrunt.hcl to root.hcl"
video:
  videoUrl: https://www.youtube.com/watch?v=GZMh3SsQOdo
  duration: 989
...
<div class="not-content flex">
  <iframe
    ...
    width="560"
    height="315"
    src="https://www.youtube.com/embed/GZMh3SsQOdo?si=Pkwq0xM5KlcmxxkA"
    title="Terragrunt Units - Video"
    allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
    allowFullScreen
    loading="lazy"
    referrerPolicy="strict-origin-when-cross-origin"
    aria-label="Terragrunt Units - Video"
...
An example of a unit in our repository: [root folder](https://github.com/Nerdeez/terragrunt-catalog/tree/main/iac/gcp/tofu/common/folders/root).
...
Just like in our repository: [root terragrunt.hcl](https://github.com/Nerdeez/terragrunt-catalog/tree/main/iac/gcp/tofu).
...
You can examine the migration in the following [PR](https://github.com/Nerdeez/terragrunt-catalog/pull/12)
