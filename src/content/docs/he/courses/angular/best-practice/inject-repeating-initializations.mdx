...
authors:
  - yariv-katz
video:
  videoUrl: https://www.youtube.com/watch?v=AqXHyIfxC5U
  duration: 442
...
<div class="not-content flex">
	<iframe
		...
		title="Angular - injection functions for repeating initializations - video"
		allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
		allowFullScreen
		loading="lazy"
		referrerPolicy="strict-origin-when-cross-origin"
		aria-label="Angular - injection functions for repeating initializations - video"
