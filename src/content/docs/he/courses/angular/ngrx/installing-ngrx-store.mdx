...
ניתן לקרוא על זה ב - <a className="text-green/80 underline" href="/he/courses/angular/best-practices/onpush">עצה טובה זו</a> ולהוסיף כלל lint לוודא שכל הרכיבים באפליקציה מוגדרים עם `OnPush`.
:::
...
ניתן לקרוא על זה ב - <a className="text-green/80 underline" href="/he/courses/angular/ngrx/best-practices/store-devtools-production">עצה טובה זו</a>
:::
