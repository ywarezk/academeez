...
Follow <a className="text-green/80 underline" href="/he/course/angular/best-practices/onpush">this</a> best practice tip to make angular cli generate `OnPush` components, as well as adding a lint rule to verify `OnPush` is set for all components
:::
...
Check out our best practice tip <a className="text-green/80 underline" href="/he/courses/angular/ngrx/best-practices/store-devtools-production">here</a>
:::
