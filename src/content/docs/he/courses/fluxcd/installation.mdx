...
<div class="not-content flex">
  <iframe
    ...
    title="Installing Flux with flux-cli - video"
    allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
    allowFullScreen
    loading="lazy"
    referrerPolicy="strict-origin-when-cross-origin"
    aria-label="Installing Flux with flux-cli - video"
    aria-describedby="iframe-video-description"
  />
</div>
<span id="iframe-video-description" class="sr-only">
This video provides a comprehensive guide on installing FluxCD using the flux-cli tool, covering prerequisites, setup steps, and best practices for managing Kubernetes clusters with GitOps principles.
</span>
...
קוד המקור המלא לשיעור זה זמין [כאן](https://github.com/Nerdeez/terragrunt-catalog/tree/lesson-01)