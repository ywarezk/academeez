...
<div class="not-content flex">
  <iframe
		...
		title="Installing FluxCD on a K8S Cluster with Terraform/OpenTofu - video"
		allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
		allowFullScreen
		loading="lazy"
		referrerPolicy="strict-origin-when-cross-origin"
		aria-label="Installing FluxCD on a K8S Cluster with Terraform/OpenTofu - video"
		aria-describedby="iframe-video-description"
  />
</div>
<span id="iframe-video-description" class="sr-only">
This video provides a detailed tutorial on installing FluxCD on a Kubernetes cluster using Terraform or OpenTofu, covering the necessary steps and best practices for setting up GitOps in a cloud environment.
</span>
...
ואל תשכחו לתת כוכב ל-[מאגר הקורס](https://github.com/Nerdeez/terragrunt-catalog), זה עוזר לנו המון.
...
במידה ואתם מנהלים רק קלאסטר אחד ואתם היחידים שמנהלים אותו, אז זה לא כל כך חשוב אם אתם מתקינים את Flux באמצעות CLI או terraform, אבל כאשר הדברים מתחילים להתרחב, ויש לכם מספר רב של קלאסטרים, או יש לכם מספר רב של צוותים, או יש לכם מספר רב של סביבות, אז חשוב להזדהות עם ה-infrastructure וההתקנה של Flux באמצעות IAC.
...
במהלך הקורס אנחנו נציג את השינויים בענן באמצעון דוגמאות infrastructure as code באמצעות שימוש ב-OpenTofu, אבל ניתן להשתמש בכל טכנולוגיה שמתאימה לכם, בנוסף ניתן להציע דוגמאות בטכנולוגיות אחרות על פי בקשה.
ניתן לראות את קוד השיעור [כאן](https://github.com/Nerdeez/terragrunt-catalog/tree/lesson-04/iac).
