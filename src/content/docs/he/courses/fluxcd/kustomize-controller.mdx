...
<div class="not-content flex">
  <iframe
    ...
    title="FluxCD - kustomize-controller - video"
    allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
    allowFullScreen
    loading="lazy"
    referrerPolicy="strict-origin-when-cross-origin"
    aria-label="FluxCD - kustomize-controller - video"
    aria-describedby="iframe-video-description"
  />
</div>
<span id="iframe-video-description" class="sr-only">
This video provides a comprehensive tutorial on using FluxCD's kustomize-controller to manage Kubernetes resources with kustomize, including practical steps for creating and applying Kustomization resources in a cluster.
</span>
...
קוד המקור המלא זמין [כאן](https://github.com/Nerdeez/terragrunt-catalog/tree/lesson-02)
