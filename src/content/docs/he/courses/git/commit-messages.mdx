...
<div class="not-content flex">
    ...
    title="Git - Commit Message - video"
    allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
    allowFullScreen
    loading="lazy"
    referrerPolicy="strict-origin-when-cross-origin"
    aria-label="Git - Commit Message - video"
    aria-describedby="iframe-video-description"
	/>
</div>
<span id="iframe-video-description" class="sr-only">
This video provides a comprehensive tutorial on using Git commit messages effectively, including practical steps for writing clear and consistent commit messages.
</span>
