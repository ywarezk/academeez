...
source: "https://github.com/ywarezk/academeez-k8s-flux/tree/lesson-01"
prev: false
editUrl: "https://github.com/ywarezk/academeez4/edit/main/src/content/docs/he/courses/kubernetes/flux/installation.mdx"
sidebar:
  order: 1
authors:
  - "yariv-katz"
