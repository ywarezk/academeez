...
<div class="not-content flex">
	<iframe
		...
		title="React - Single Responsibility Principle - video"
		allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
		allowFullScreen
		loading="lazy"
		referrerPolicy="strict-origin-when-cross-origin"
		aria-label="React - Single Responsibility Principle - video"
		aria-describedby="iframe-video-description"
	/>
</div>
<span id="iframe-video-description" class="sr-only">
This video explains the Single Responsibility Principle in React, demonstrating how to create components that adhere to this principle for better code organization and maintainability with practical examples.
</span>
