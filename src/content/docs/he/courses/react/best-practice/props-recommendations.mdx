...
<div class="not-content flex">
	<iframe
		...
		title="React Props Best Practices - video"
		allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
		allowFullScreen
		loading="lazy"
		referrerPolicy="strict-origin-when-cross-origin"
		aria-label="React Props Best Practices - video"
		aria-describedby="iframe-video-description"
	/>
</div>
<span id="iframe-video-description" class="sr-only">
This video explains best practices for using props in React, including tips on prop drilling, naming conventions, optional props, default values, and using TypeScript for type safety with practical examples.
</span>
