...
<div class="not-content flex">
	<iframe
		...
		title="Understanding React Elements - video"
		allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
		allowFullScreen
		loading="lazy"
		referrerPolicy="strict-origin-when-cross-origin"
		aria-label="Understanding React Elements - video"
		aria-describedby="iframe-video-description"
	/>
</div>
<span id="iframe-video-description" class="sr-only">
This video provides a comprehensive introduction to React Elements, explaining their purpose, how to create them, and their role in building user interfaces with practical examples.
</span>
