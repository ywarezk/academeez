...
<CardGrid stagger>
  <Card>
    <CardContentCourse title="Kubernetes" img="k8s">
      You program your app, place it in a container (usually with Docker), and you can orchestrate those containers with Kubernetes.  
      <br/>
...
<br/>
<CourseCarousel client:load title="Kubernetes / Flux" courseLink="kubernetes/flux" />

<br/>
<CourseCarousel client:load title="Angular" courseLink="angular" />