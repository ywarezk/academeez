...
<br/>
<CourseCarousel client:load title="Kubernetes / Flux" courseLink="/courses/kubernetes/flux" slug="kubernetes/flux" />

<br/>
<CourseCarousel client:load title="Angular" courseLink="/courses/angular" slug="angular" />